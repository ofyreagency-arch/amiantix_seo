...
class BusinessCopilotServiceTest extends TestCase
{
    ...
    public function test_marks_unmapped_gsc_page_as_manual_apply(): void
    {
        ...
        $this->assertStringContainsString('/preview', (string) ($payload['top_action']['apply_href'] ?? ''));
        ...
        $this->assertSame('preview_then_confirm', $payload['top_action']['apply_context']['live_site_impact'] ?? null);
    }
}
