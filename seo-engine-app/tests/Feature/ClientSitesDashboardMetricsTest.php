...
class ClientSitesDashboardMetricsTest extends TestCase
{
    ...
    public function test_installation_status_serialization_ignores_latest_zero_inspection_rows_without_crashing(): void
    {
        $user = User::factory()->create();
        $rawToken = 'frontend-token';
        ...
        $response->assertJsonPath('site.summary.top_rising_pages.0.slug', 'faq');
        $response->assertJsonPath('site.summary.top_rising_pages.0.delta_impressions', 2);
    }
